...
from torch_geometric.transforms import RemoveDuplicatedEdges, RemoveSelfLoops, OneHotDegree, one_hot_degree

import lightning as L
from models.Try2 import LitFullModel
...
def transform(data: Data) -> Data:
    rem_dub = RemoveDuplicatedEdges()
    data = rem_dub(data)
    rem_self_loop = RemoveSelfLoops()
...
trainer = L.Trainer(max_epochs=hyper_params["num_epochs"], logger=comet_logger)
