...
class UWF22(datasets.UWF.UWF22):
    ...
    def __init__(self, 
        ...
        super().__init__(data_dir, bin_size, batch_size, from_time, to_time, transforms, num_workers, batch_split, dataset_name)
